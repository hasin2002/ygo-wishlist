      ...
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-7 rounded-2xl border border-zinc-300 bg-white p-5 shadow-sm sm:p-7">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            {connection ? <span className="inline-flex w-fit items-center gap-1.5 rounded-full bg-emerald-50 px-3 py-1.5 text-sm font-bold text-emerald-800"><CheckCircle2 className="size-4" />Connection stored</span> : <span className="inline-flex w-fit items-center gap-1.5 rounded-full bg-zinc-100 px-3 py-1.5 text-sm font-bold text-zinc-600">Not connected</span>}
          </div>
