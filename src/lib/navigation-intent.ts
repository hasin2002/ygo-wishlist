...
export function addTaskHref(taskPathname: "/records/new/owned" | "/wishlist/new" | "/records/new/purchase" | "/records/new/opening" | "/records/new/sale" | "/records/listings/new" | "/records/listings/new-lot", origin: string | NavigationIntent | null | undefined) {
